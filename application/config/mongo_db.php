...
$config['mongo_db']['default']['username'] = 'identity';
$config['mongo_db']['default']['password'] = 'c5305de22a69635e54347cf3c174535906';
$config['mongo_db']['default']['database'] = 'identity_manager';
